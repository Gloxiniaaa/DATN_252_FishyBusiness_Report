...
\subsection{Bối cảnh và vấn đề đặt ra}
    Thị trường game hiện nay đang chứng kiến sự trỗi dậy mạnh mẽ của dòng game \textit{Social Deduction} (Suy luận xã hội) và \textit{Party Game}. Những cái tên như \textit{Among Us}, \textit{Liars Bar} hay \textit{Party Animals} đã chứng minh một chân lý: người chơi hiện đại không chỉ tìm kiếm thử thách về kỹ năng, họ khao khát sự kết nối. Họ muốn một không gian ảo nơi họ có thể tương tác, lừa lọc, cười đùa và "tương tàn" với bạn bè mình.\\
\begin{figure}[H]
    \centering
    \begin{minipage}[b]{0.32\linewidth}
        \centering
        \includegraphics[width=\linewidth]{1.Giới thiệu/images/amongus.png}
        \par\small\textbf{Among Us}
    \end{minipage}\hfill
    \begin{minipage}[b]{0.32\linewidth}
        \centering
        \includegraphics[width=\linewidth]{1.Giới thiệu/images/liarsbar.png}
        \par\small\textbf{Liars Bar}
    \end{minipage}\hfill
    \begin{minipage}[b]{0.32\linewidth}
        \centering
        \includegraphics[width=\linewidth]{1.Giới thiệu/images/party-animals.png}
        \par\small\textbf{Party Animals}
    \end{minipage}
    \caption{Một số game thể loại Social Deduction và Party Game nổi bật}
\end{figure}
...
\input{1.Giới thiệu/SaboteurRule}
\input{1.Giới thiệu/NewSaboteurRule}
