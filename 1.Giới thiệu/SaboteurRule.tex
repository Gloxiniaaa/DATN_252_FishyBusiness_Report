...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textbf{Thẻ cụt (dead-end)}: Có thể nối với các thẻ khác nhưng không được tính là thông đường.
  ...
  Tất cả thẻ Đường đều có thể được xoay 180 độ trước khi đặt xuống.  
  \begin{itemize}
    \item Người chơi không được xoay 90 độ; chỉ xoay 180 độ vì cấu trúc hầm được thiết kế theo hai hướng chính.
