...
\begin{itemize}
    ...
    \item \textbf{Ưu điểm:} 
    \begin{enumerate}[+]
        \item Tính ổn định cao vì server là máy chạy độc lập, không bị ảnh hưởng bởi người chơi. Người chơi rốt mạng hoặc thoát thì server vẫn chạy.
...
\begin{itemize}
    ...
    \begin{enumerate}[+]
        ...
        \item Vì người chơi Host cũng chính là Server nên mỗi lần chơi thử không cần tốn thời gian theo dõi trạng thái server, thuận thiện hơn cho quá trình tìm lỗi.
